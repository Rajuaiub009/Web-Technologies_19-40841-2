	...
	<tbody>
		<?php foreach ($sellers as $i => $seller): ?>
			<tr>
                ...
                <td><a href="../View/editSeller.php?id=<?php echo $seller['ID'] ?>">Edit</a>&nbsp<a href="../Controller/deleteSeller.php?id=<?php echo $seller['username'] ?>" onclick="return confirm('Are you sure want to delete this ?')">Delete</a></td>
